let globe3d = {
    ...
    ec01_map() {
        ...
        let MagellanPoints = [
            {name: '塞维利亚', oldName: ''},
            {name: '桑卢卡尔－德巴拉梅达', oldName: '', time: '1519年9月20日', remark: '西班牙'},
            {name: '加纳利群岛', oldName: ''},
            ...
            {name: '马里亚纳群岛', oldName: '强盗岛',  remark: ''},
            {name: '太平洋辅助点16', oldName: '', time: '', remark: ''},
            {name: '太平洋辅助点17', oldName: '', time: '', remark: ''},
            {name: '萨玛1', oldName: '', remark: ''},
            {name: '萨玛2', oldName: '', remark: ''},
            {name: '霍蒙洪岛', oldName: '', remark: ''},
            {name: '利马萨瓦', oldName: ''},
            {name: '宿雾岛', oldName: ''},
            {name: '麦克坦', oldName: ''},
            {name: '巴拉望', oldName: '', time: '', remark: ''},
            {name: '文莱', oldName: '', time: '', remark: ''},
            {name: '蒂多雷', oldName: '',  remark: ''},
            {name: '安汶岛', oldName: '',  remark: ''},
            {name: '帝汶', oldName: '',  remark: ''},
