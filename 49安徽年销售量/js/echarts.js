$(function () {
    ...
    function ceshis() {
        ...
        option = {
            ...
            xAxis: [{
                type: 'category',
                data: ['营养土调配 (㎡)', '种子催芽 (颗)', '幼苗温控培育 (株)', '移植养护 (株)', '温室环境调控 (时段)', '绿植硬化定植 (株)', '营养土调配 (㎡)', '种子催芽 (颗)', '幼苗温控培育 (株)', '移植养护 (株)', '温室环境调控 (时段)', '绿植硬化定植 (株)',
                    '绿植硬化定植 (株)', '种子催芽 (颗)', '幼苗温控培育 (株)', '移植养护 (株)', '绿植硬化定植 (株)', '种子催芽 (颗)', '幼苗温控培育 (株)', '移植养护 (株)', '移植养护 (株)', '绿植硬化定植 (株)',
                ],
                axisLabel: {
                    show: true,
                    textStyle: {
    ...
    function ceshis1() {
        ...
        var xdata = ['绿萝', "吊兰", "龟背竹", "琴叶榕", '橡皮树', '鹅掌柴', '散尾葵', '春羽', '鹿角蕨', '马醉木'];
    ...
    function ceshis2() {
        ...
        option = {
            ...
            "legend": {
                ...
                "padding": [70, 20],
                "itemGap": 5,
                "data": ["紫荆", "含笑", "红叶李", "雏菊", "鸢尾", "风信子", "紫云英", "其它"]
            },
            "series": [{
                "type": "pie",
                "center": ["50%", "40%"],
