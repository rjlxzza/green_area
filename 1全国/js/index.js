		        ...
		        },*/
		        {
		            ...
		            label: {
		                ...
		                formatter(params) {
		                    ...
		                    let arr = [params.name, "参与绿顶：" + params.value[1] + "家"];
		                    return arr.join("\n")
		                },
		                textStyle: {
		                    align: 'left',
...
function wuran(){
	...
	var salvProName =["老旧小区","高层小区总数","学校总数","企业总数","公关单位"];
...
function zhexian() {
	...
	dataObj = {
		...
		data: {
			value: [{
				name: '一线城市',
				value: [127, 224, 227, 250, 278, 355]
			}, {
				name: '二线城市',
				value: [74, 99, 120, 127, 157, 178]
			}, {
				name: '三线城市',
				value: [27, 50, 78, 100, 125, 144]
			}]
		}
	}
	let dataArr = []
	...
	dataObj.data.value.map(item => {
		...
		let newArr = {
			...
			itemStyle: {
				normal: {
					color: item.name === '一线城市' ? '#f0c725' : item.name === '二线城市' ? '#0BE3FF' : '#16f892'
				}
			}
		}
...
myChart.on('click', function(params) {
	if (params.name === '安徽') {
		window.location.href = '../2安徽/index.html';
	}
});

//支持绿顶城市TOP5点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("top2");
	top5Container.addEventListener("click", function() {
		window.location.href = "../2支持绿顶城市top5/index.html";
	});
});

// 绿顶城市占比点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("huaxing");
	top5Container.addEventListener("click", function() {
		window.location.href = "../8绿顶城市占比/index.html";
	});
});

// 主要地区增长量点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("zhexian");
	top5Container.addEventListener("click", function() {
		window.location.href = "../69主要地区增长量/index.html";
	});
});

// 多地区绿顶监测点击切换
// document.addEventListener("DOMContentLoaded", function() {
// 	var top5Container = document.getElementById(id="top1");
// 	top5Container.addEventListener("click", function() {
...
// 绿顶分布情况点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("leida");
	top5Container.addEventListener("click", function() {
		window.location.href = "../5 绿顶分布情况/index.html";
	});
});
...
// 绿顶固碳覆盖情况点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("wuran");
	top5Container.addEventListener("click", function() {
		window.location.href = "../17绿顶固碳覆盖情况/index.html";
	});
});

// 绿顶固碳覆盖情况点击切换
document.addEventListener("DOMContentLoaded", function() {
	var top5Container = document.getElementById("denglu");
	top5Container.addEventListener("click", function() {
		window.location.href = "../3.登录注册框/login.html";
	});
});
